...
function reverseElement(object) {
    ...
    //apartar la propiedad anteior a la última y cambiarla por la siguiente a la primera
    for (var i = object.length - 1; i > (object.length - 1) / 2; i--) {
        ...
        // i = 2 // 2 -> 2 > 2 -> se paran las operaciones(porque 2 no es menos que 2)
        // i = 3 - 1 -> i = 2 // 3 - 1 = 2 / 2 = 1 -> 2 > 1 -> hacemos operaciones
        // i = 1 // 1 -> 1 > 1 -> parar de hacer ñas operaciones
...
console.log("numbers reserved", reverseElement(numbers))
